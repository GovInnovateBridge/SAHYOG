...
$cropArea = New-Object System.Drawing.Rectangle(0, 0, $img.Width, 763)
...
$bitmap.Save("Frontend\public\hero-mockup.png", [System.Drawing.Imaging.ImageFormat]::Png)
$graphics.Dispose()
$bitmap.Dispose()
$img.Dispose()
Write-Host "Cropped to 763 height"
